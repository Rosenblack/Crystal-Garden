package net.shale.horde.crystalgarden.block.moditems;
...
import net.shale.horde.crystalgarden.block.extend.Combiner;

public class machines {
    public static final Block COMBINER = registerBlock("machines/combiner",
